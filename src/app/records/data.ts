...
export const ranking2025: AthleteRankings[] = [
  {
    ...
    self: {
      ...
      ocean: { rank: 44, points: 6, events: 3 },
      pool: null,
    },
  },
  {
    ...
    totalTop: [
      { rank: 1, name: "鴨林 夏花", club: "西浜サーフライフセービングクラブ", points: 148, highlight: "" },
      { rank: 2, name: "藤﨑 笑佳", club: "西浜サーフライフセービングクラブ", points: 138, highlight: "" },
      { rank: 3, name: "河端 詩央梨", club: "KITAJIMAQUATICS", points: 123, highlight: "" },
      { rank: 4, name: "柳 輝於", club: "KITAJIMAQUATICS", points: 114, highlight: "" },
      { rank: 5, name: "髙田 琉衣", club: "湘南GoldenAgeアカデミー", points: 109, highlight: "" },
      { rank: 6, name: "塚根 小夏", club: "湘南GoldenAgeアカデミー", points: 106, highlight: "" },
      { rank: 7, name: "古賀 夏美", club: "西浜サーフライフセービングクラブ", points: 85, highlight: "" },
      { rank: 8, name: "上野 美月", club: "西浜サーフライフセービングクラブ", points: 75, highlight: "" },
      { rank: 9, name: "内藤 希音", club: "鎌倉ライフガード", points: 54, highlight: "" },
      { rank: 10, name: "小池 侑依", club: "KITAJIMAQUATICS", points: 46, highlight: "" },
    ],
    oceanTop: [
      { rank: 1, name: "鴨林 夏花", club: "西浜サーフライフセービングクラブ", points: 85, highlight: "" },
      { rank: 2, name: "塚根 小夏", club: "湘南GoldenAgeアカデミー", points: 69, highlight: "" },
      { rank: 3, name: "髙田 琉衣", club: "湘南GoldenAgeアカデミー", points: 68, highlight: "" },
      { rank: 4, name: "藤﨑 笑佳", club: "西浜サーフライフセービングクラブ", points: 64, highlight: "" },
      { rank: 5, name: "上野 美月", club: "西浜サーフライフセービングクラブ", points: 62, highlight: "" },
      { rank: 6, name: "内藤 希音", club: "鎌倉ライフガード", points: 54, highlight: "" },
      { rank: 7, name: "矢上 陽葉", club: "館山サーフライフセービングクラブ", points: 42, highlight: "本人" },
      { rank: 8, name: "古賀 夏美", club: "西浜サーフライフセービングクラブ", points: 40, highlight: "" },
      { rank: 9, name: "丸山 はやか", club: "鎌倉ライフガード", points: 33, highlight: "" },
      { rank: 10, name: "常盤 珠絆", club: "勝浦ライフセービングクラブ", points: 29, highlight: "" },
    ],
    poolTop: [
      { rank: 1, name: "河端 詩央梨", club: "KITAJIMAQUATICS", points: 96, highlight: "" },
      { rank: 2, name: "柳 輝於", club: "KITAJIMAQUATICS", points: 93, highlight: "" },
      { rank: 3, name: "藤﨑 笑佳", club: "西浜サーフライフセービングクラブ", points: 74, highlight: "" },
      { rank: 4, name: "鴨林 夏花", club: "西浜サーフライフセービングクラブ", points: 63, highlight: "" },
      ...
      { rank: 8, name: "春日 あかり", club: "十文字中高", points: 39, highlight: "" },
      { rank: 9, name: "塚根 小夏", club: "湘南GoldenAgeアカデミー", points: 37, highlight: "" },
      { rank: 10, name: "小池 侑依", club: "KITAJIMAQUATICS", points: 35, highlight: "" },
    ],
    self: {
      total: { rank: 12, points: 42, events: 5 },
      ocean: { rank: 7, points: 42, events: 5 },
      pool: null,
    },
  },
  {
