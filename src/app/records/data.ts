...
export const ranking2025: AthleteRankings[] = [
  ...
  },
  {
    ...
    totalTop: [
      { rank: 1, name: "藤﨑 笑佳", club: "西浜サーフライフセービングクラブ", points: 127, highlight: "" },
      { rank: 2, name: "鴨林 夏花", club: "西浜サーフライフセービングクラブ", points: 123, highlight: "" },
      { rank: 3, name: "柳 輝於", club: "KITAJIMAQUATICS", points: 114, highlight: "" },
      { rank: 4, name: "髙田 琉衣", club: "湘南GoldenAgeアカデミー", points: 109, highlight: "" },
      { rank: 5, name: "河端 詩央梨", club: "KITAJIMAQUATICS", points: 108, highlight: "" },
      { rank: 6, name: "塚根 小夏", club: "湘南GoldenAgeアカデミー", points: 90, highlight: "" },
      { rank: 7, name: "古賀 夏美", club: "西浜サーフライフセービングクラブ", points: 78, highlight: "" },
      { rank: 8, name: "上野 美月", club: "西浜サーフライフセービングクラブ", points: 75, highlight: "" },
      { rank: 9, name: "小池 侑依", club: "KITAJIMAQUATICS", points: 46, highlight: "" },
      { rank: 10, name: "鈴木 萌那", club: "KITAJIMAQUATICS", points: 43, highlight: "" },
    ],
    oceanTop: [
      ...
      { rank: 4, name: "藤﨑 笑佳", club: "西浜サーフライフセービングクラブ", points: 53, highlight: "" },
      { rank: 6, name: "矢上 陽葉", club: "館山サーフライフセービングクラブ", points: 42, highlight: "本人" },
      { rank: 7, name: "内藤 希音", club: "鎌倉ライフガード", points: 39, highlight: "" },
      { rank: 8, name: "古賀 夏美", club: "西浜サーフライフセービングクラブ", points: 33, highlight: "" },
      { rank: 8, name: "丸山 はやか", club: "鎌倉ライフガード", points: 33, highlight: "" },
      { rank: 10, name: "常盤 珠絆", club: "勝浦ライフセービングクラブ", points: 29, highlight: "" },
    ],
    poolTop: [
      { rank: 1, name: "柳 輝於", club: "KITAJIMAQUATICS", points: 93, highlight: "" },
      { rank: 2, name: "河端 詩央梨", club: "KITAJIMAQUATICS", points: 81, highlight: "" },
      { rank: 3, name: "藤﨑 笑佳", club: "西浜サーフライフセービングクラブ", points: 74, highlight: "" },
      { rank: 4, name: "鴨林 夏花", club: "西浜サーフライフセービングクラブ", points: 52, highlight: "" },
      { rank: 5, name: "古賀 夏美", club: "西浜サーフライフセービングクラブ", points: 45, highlight: "" },
      { rank: 6, name: "鈴木 萌那", club: "KITAJIMAQUATICS", points: 41, highlight: "" },
      { rank: 6, name: "髙田 琉衣", club: "湘南GoldenAgeアカデミー", points: 41, highlight: "" },
      { rank: 8, name: "塚根 小夏", club: "湘南GoldenAgeアカデミー", points: 37, highlight: "" },
      { rank: 9, name: "小池 侑依", club: "KITAJIMAQUATICS", points: 35, highlight: "" },
      { rank: 10, name: "髙松 澪", club: "K-AQUA", points: 30, highlight: "" },
    ],
    self: {
      total: { rank: 11, points: 42, events: 5 },
      ocean: { rank: 6, points: 42, events: 5 },
      pool: null,
    },
  },
  {
...
export const allRankings: CategoryRanking[] = [
  ...
  },
  {
    ...
    totalTop: [
      ...
      { rank: 5, name: "髙田 夏都", club: "KITAJIMAQUATICS", points: 75, highlight: "" },
      { rank: 6, name: "北沢 泰雅", club: "鎌倉ライフガード", points: 72, highlight: "" },
      { rank: 7, name: "福田 諒", club: "KITAJIMAQUATICS", points: 70, highlight: "" },
      { rank: 8, name: "高木 秀征", club: "西浜サーフライフセービングクラブ", points: 67, highlight: "" },
    ...
    oceanTop: [
      ...
      { rank: 2, name: "大野 快", club: "鎌倉ライフガード", points: 49, highlight: "" },
      { rank: 3, name: "米林 志", club: "鎌倉ライフガード", points: 46, highlight: "" },
      { rank: 3, name: "谷 陽向", club: "湘南GoldenAgeアカデミー", points: 46, highlight: "" },
      { rank: 5, name: "寺地 晴之介", club: "湯河原ライフセービングクラブ", points: 41, highlight: "" },
      { rank: 5, name: "筒井 遼介", club: "湯河原ライフセービングクラブ", points: 41, highlight: "" },
    ...
    poolTop: [
      { rank: 1, name: "福田 諒", club: "KITAJIMAQUATICS", points: 63, highlight: "" },
      { rank: 2, name: "槍田 力", club: "西浜SLSC", points: 54, highlight: "" },
      ...
      { rank: 5, name: "髙田 夏都", club: "KITAJIMAQUATICS", points: 48, highlight: "" },
      { rank: 7, name: "北川 成", club: "鎌倉ライフガード", points: 44, highlight: "" },
      { rank: 8, name: "寺地 晴之介", club: "湯河原ライフセービングクラブ", points: 37, highlight: "" },
