...
export const ranking2025: AthleteRankings[] = [
  {
    ...
    totalTop: [
      ...
      { rank: 2, name: "千葉 まひる", club: "館山サーフライフセービングクラブ", points: 83, highlight: "館山勢" },
      ...
      { rank: 7, name: "飯野 花梨", club: "十文字中学・高等学校ライフセービングクラブ", points: 58, highlight: "" },
      { rank: 8, name: "林 美穂", club: "十文字中学・高等学校ライフセービングクラブ", points: 54, highlight: "" },
      { rank: 9, name: "成海 幸波", club: "館山サーフライフセービングクラブ", points: 53, highlight: "館山勢" },
      { rank: 10, name: "岸 愛姫", club: "日本体育大学荏原高等学校ライフセービングクラブ", points: 47, highlight: "" },
    ],
    oceanTop: [
      { rank: 1, name: "成海 幸波", club: "館山サーフライフセービングクラブ", points: 53, highlight: "館山勢" },
      { rank: 2, name: "槍田 愛", club: "西浜サーフライフセービングクラブ", points: 41, highlight: "" },
      { rank: 3, name: "花塚 聖奈", club: "西浜サーフライフセービングクラブ", points: 36, highlight: "" },
      { rank: 4, name: "佐藤 志帆子", club: "西浜サーフライフセービングクラブ", points: 34, highlight: "" },
      { rank: 5, name: "富田 優佳子", club: "西浜サーフライフセービングクラブ", points: 32, highlight: "" },
      { rank: 5, name: "岸 愛姫", club: "日本体育大学荏原高等学校ライフセービングクラブ", points: 32, highlight: "" },
      { rank: 7, name: "石黒 未波", club: "館山サーフライフセービングクラブ", points: 30, highlight: "館山勢" },
      { rank: 8, name: "永山 心愛", club: "成城学園高等学校ライフセービングクラブ", points: 28, highlight: "" },
      { rank: 9, name: "杉山 冬華", club: "日本体育大学荏原高等学校ライフセービングクラブ", points: 27, highlight: "" },
      { rank: 9, name: "飯野 花梨", club: "十文字中学・高等学校ライフセービングクラブ", points: 27, highlight: "" },
    ],
    poolTop: [
  ...
  },
  {
    ...
    totalTop: [
      { rank: 1, name: "髙田 琉衣", club: "湘南GoldenAgeアカデミー", points: 94, highlight: "" },
      { rank: 2, name: "鴨林 夏花", club: "西浜サーフライフセービングクラブ", points: 88, highlight: "" },
      { rank: 3, name: "河端 詩央梨", club: "KITAJIMAQUATICS", points: 82, highlight: "" },
      { rank: 4, name: "藤﨑 笑佳", club: "西浜サーフライフセービングクラブ", points: 81, highlight: "" },
      { rank: 5, name: "柳 輝於", club: "KITAJIMAQUATICS", points: 75, highlight: "" },
      { rank: 6, name: "塚根 小夏", club: "湘南GoldenAgeアカデミー", points: 60, highlight: "" },
      { rank: 7, name: "上野 美月", club: "西浜サーフライフセービングクラブ", points: 58, highlight: "" },
      { rank: 8, name: "古賀 夏美", club: "西浜サーフライフセービングクラブ", points: 53, highlight: "" },
      { rank: 9, name: "小池 侑依", club: "KITAJIMAQUATICS", points: 46, highlight: "" },
      { rank: 10, name: "矢上 陽葉", club: "館山サーフライフセービングクラブ", points: 35, highlight: "本人" },
    ],
    oceanTop: [
      { rank: 1, name: "髙田 琉衣", club: "湘南GoldenAgeアカデミー", points: 58, highlight: "" },
      { rank: 2, name: "鴨林 夏花", club: "西浜サーフライフセービングクラブ", points: 56, highlight: "" },
      { rank: 3, name: "上野 美月", club: "西浜サーフライフセービングクラブ", points: 49, highlight: "" },
      { rank: 4, name: "塚根 小夏", club: "湘南GoldenAgeアカデミー", points: 37, highlight: "" },
      { rank: 5, name: "矢上 陽葉", club: "館山サーフライフセービングクラブ", points: 35, highlight: "本人" },
      { rank: 6, name: "丸山 はやか", club: "鎌倉ライフガード", points: 33, highlight: "" },
      { rank: 7, name: "常盤 珠絆", club: "勝浦ライフセービングクラブ", points: 29, highlight: "" },
      { rank: 8, name: "河端 詩央梨", club: "KITAJIMAQUATICS", points: 27, highlight: "" },
      { rank: 9, name: "上田 香蓮", club: "湘南GoldenAgeアカデミー", points: 25, highlight: "" },
      { rank: 9, name: "佐藤 禾子", club: "鎌倉ライフガード", points: 25, highlight: "" },
    ],
    poolTop: [
    ...
    self: {
      total: { rank: 10, points: 35, events: 4 },
      ocean: { rank: 5, points: 35, events: 4 },
      pool: null,
    },
  },
  {
...
export const allRankings: CategoryRanking[] = [
  ...
  },
  {
    ...
    label: "U18男子",
    totalTop: [
      { rank: 1, name: "浜地 櫂依", club: "西浜サーフライフセービングクラブ", points: 156, highlight: "" },
      { rank: 2, name: "高田 理世", club: "西浜サーフライフセービングクラブ", points: 130, highlight: "" },
      { rank: 3, name: "中村 孔信", club: "日本体育大学荏原高等学校ライフセービングクラブ", points: 111, highlight: "" },
      { rank: 4, name: "小松 壮", club: "館山サーフライフセービングクラブ", points: 110, highlight: "館山勢" },
      { rank: 5, name: "横矢 翔", club: "館山サーフライフセービングクラブ", points: 62, highlight: "館山勢" },
      { rank: 6, name: "青山 希助", club: "日本体育大学荏原高等学校ライフセービングクラブ", points: 60, highlight: "" },
      { rank: 7, name: "百田 梅吉", club: "KITAJIMAQUATICS", points: 59, highlight: "" },
      { rank: 8, name: "上野 佑太", club: "日本体育大学荏原高等学校ライフセービングクラブ", points: 57, highlight: "" },
      { rank: 8, name: "西川 温人", club: "西浜サーフライフセービングクラブ", points: 57, highlight: "" },
      { rank: 10, name: "田畑 佑笑", club: "西浜サーフライフセービングクラブ", points: 55, highlight: "" },
    ],
    oceanTop: [
      { rank: 1, name: "高田 理世", club: "西浜サーフライフセービングクラブ", points: 74, highlight: "" },
      { rank: 2, name: "浜地 櫂依", club: "西浜サーフライフセービングクラブ", points: 69, highlight: "" },
      { rank: 3, name: "西川 温人", club: "西浜サーフライフセービングクラブ", points: 54, highlight: "" },
      { rank: 4, name: "田畑 佑笑", club: "西浜サーフライフセービングクラブ", points: 39, highlight: "" },
      { rank: 5, name: "菅野 滉太", club: "西浜サーフライフセービングクラブ", points: 37, highlight: "" },
      { rank: 6, name: "中村 孔信", club: "日本体育大学荏原高等学校ライフセービングクラブ", points: 33, highlight: "" },
      { rank: 6, name: "井上 大地", club: "西浜サーフライフセービングクラブ", points: 33, highlight: "" },
      { rank: 8, name: "岡安 海斗", club: "西浜サーフライフセービングクラブ", points: 32, highlight: "" },
      { rank: 9, name: "池戸 真誉", club: "西浜サーフライフセービングクラブ", points: 30, highlight: "" },
      { rank: 10, name: "小松 壮", club: "館山サーフライフセービングクラブ", points: 28, highlight: "館山勢" },
    ],
    poolTop: [
  ...
  },
  {
    ...
    totalTop: [
      ...
      { rank: 3, name: "土谷 颯真", club: "西浜サーフライフセービングクラブ", points: 76, highlight: "" },
      { rank: 3, name: "菅野 陽仁", club: "西浜サーフライフセービングクラブ", points: 76, highlight: "" },
      { rank: 5, name: "北沢 泰雅", club: "鎌倉ライフガード", points: 72, highlight: "" },
      { rank: 6, name: "高木 秀征", club: "西浜サーフライフセービングクラブ", points: 64, highlight: "" },
    ...
    oceanTop: [
      ...
      { rank: 8, name: "郷田 純一郎", club: "鎌倉ライフガード", points: 36, highlight: "" },
      { rank: 9, name: "高木 秀征", club: "西浜サーフライフセービングクラブ", points: 35, highlight: "" },
