...
const timeline = [
  { year: "2022", title: "全日本大会 初出場", desc: "陽葉が小学5年生で全日本ジュニア・ユース・マスターズプール大会に初出場。館山SLSCから障害物スイム50mに挑み、12位。藤﨑笑佳と共にリレーにも出場。" },
  { year: "2023", title: "2年連続出場・成長の手応え", desc: "陽葉が障害物スイム50mで36.57秒（前年比-2.94秒）と大幅にタイムを更新。チューブトウ100mも1:31.24と着実に成長。" },
  { year: "2024", title: "結月も全日本デビュー", desc: "長女・結月がU15カテゴリで全日本大会に初参戦。陽葉と共に障害物スイム・マネキンキャリー・マネキントウの全種目にエントリー。" },
